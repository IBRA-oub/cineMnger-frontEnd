                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full p-6">
                    {reservation.map((reservation) => (
                        <div className="relative mx-auto w-full">
                            ...
                            <div key={reservation.id} className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
                                <div className="shadow p-4 rounded-lg bg-black text-white">
                                    ...
                                    <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                                        ...
                                        <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-200">
                                            ...
                                            <span class="mt-2 xl:mt-0">
                                                <span className='font-bold text-gray-400'>seat :</span>  1, 2, 3
                                            </span>
                                        </p>
                                    </div>
