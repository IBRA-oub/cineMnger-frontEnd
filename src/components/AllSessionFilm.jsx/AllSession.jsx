    ...
    return (
        <>
            ...
            <div className='w-full h-full bg-[#121212]'>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full p-6">
                {sessions.map((session) => (
                    <div class="relative mx-auto w-full">
                    
                        <a key={session.id} href="#" class="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
                            <div class="shadow p-4 rounded-lg bg-black text-white">


                                <div class="mt-4">
                                    <h2 class="font-medium text-base md:text-lg text-gray-200 line-clamp-1" title="New York">
                                        Statue of Liberty
                                    </h2>
                                ...
                                <div class="grid grid-cols-2 mt-8">
                                    ...
                                    <div class="flex justify-end">
                                        <p class="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
                                            ...
                                            <span class="text-lg text-yellow-500">300 </span> dh/seat
                                        </p>
                                    </div>
                                </div>
                            </div>
